      ...
      <View style={tw`px-4 pt-6 h-full`}>
        ...
        <View style={[tw`my-5 p-2 bg-white`, styles.search]}>
          ...
          <TextInput
            ...
            placeholder="Search Doctor by speciality, hospital or name..."
            value={searchedText}
  ...
  return (
    <View style={tw`flex-row justify-between items-center my-2`}>
      <View style={tw`flex flex-row items-start`}>
        <Image source={{ uri: data.image }} style={styles.docImage} />
        <View style={tw`ml-3`}>
      ...
      {/* Icon */}
      <TouchableOpacity
        onPress={() => navigation.navigate("DoctorProfile", { userInfo: data })}
      >
