...
import {Avatar,VStack, Box, Button,Image, Center, Heading, Stack, HStack, AspectRatio} from "native-base";
  ...
  return (
    <View style= {styles.background} >
      ...
      <VStack space={2} alignItems={{
          ...
          <AspectRatio alignSelf='center' w="100%" ratio={16 / 12} bg='gray.900' >
            <Image source={{
        ...
        <Stack space={1}>
            ...
            <Heading size="lg" mt='10%'  alignSelf='center'  _light={{color: "black"}} >
              Spencer Brown
            </Heading>
